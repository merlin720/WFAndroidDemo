...
public class TimerImageAdapter{
    ...
    IImageChangeEvent mIImageChangeEvent;
...
//        startTimer();
    ...
    public void startTimer() {
        if (isStop){
            isStop = false;
            mIImageChangeEvent.updateState(false);
        }
    ...
    public void stopSwitchImage(){
        isStop = true;
        mIImageChangeEvent.updateState(true);
        mHandler.removeMessages(CHANGE_FLAG);
    }
    ...
    private void switchImage(){
        ...
        mOldPos = mCurrentPos;
        mCurrentPos++;
        mIImageChangeEvent.updateImage(imageRsid, mOldPos);
        mHandler.sendEmptyMessageDelayed(CHANGE_FLAG, DELAYTIME);
    }

    public void setImageChangeListener(IImageChangeEvent l) {
        mIImageChangeEvent = l;
    }
